...
from ...internal.protobuf import service as __cbi_protobuf_service__
...
class Field(betterproto.Message):
    ...
    kind: "Field.Kind" = betterproto.enum_field(1)
    """The field type."""

    cardinality: "Field.Cardinality" = betterproto.enum_field(2)
    ...
    class Cardinality(betterproto.Enum):
...
class DescriptorProto(betterproto.Message):
    ...
    extension_range: List["DescriptorProto.ExtensionRange"] = betterproto.message_field(5)
    oneof_decl: List["OneofDescriptorProto"] = betterproto.message_field(8)
    options: "MessageOptions" = betterproto.message_field(7)
    reserved_range: List["DescriptorProto.ReservedRange"] = betterproto.message_field(9)
    ...
    @dataclass(eq=False, repr=False)
    class ExtensionRange(betterproto.Message):
    ...
    @dataclass(eq=False, repr=False)
    class ReservedRange(betterproto.Message):
        """
...
class FieldDescriptorProto(betterproto.Message):
    ...
    name: str = betterproto.string_field(1)
    number: int = betterproto.int32_field(3)
    label: "FieldDescriptorProto.Label" = betterproto.enum_field(4)
    type: "FieldDescriptorProto.Type" = betterproto.enum_field(5)
    """
...
class EnumDescriptorProto(betterproto.Message):
    ...
    reserved_range: List["EnumDescriptorProto.EnumReservedRange"] = betterproto.message_field(4)
    """
    ...
    @dataclass(eq=False, repr=False)
    class EnumReservedRange(betterproto.Message):
        """
...
class FileOptions(betterproto.Message):
    ...
    optimize_for: "FileOptions.OptimizeMode" = betterproto.enum_field(9)
    ...
    class OptimizeMode(betterproto.Enum):
...
class FieldOptions(betterproto.Message):
    ctype: "FieldOptions.CType" = betterproto.enum_field(1)
    """
    ...
    jstype: "FieldOptions.JsType" = betterproto.enum_field(6)
    """
...
class ServiceOptions(betterproto.Message):
    ...
    options: Optional["__cbi_protobuf_service__.ServiceOptions"] = betterproto.message_field(1000, optional=True)
...
class MethodOptions(betterproto.Message):
    ...
    idempotency_level: "MethodOptions.IdempotencyLevel" = betterproto.enum_field(34)
    uninterpreted_option: List["UninterpretedOption"] = betterproto.message_field(999)
    """The parser stores options it doesn't recognize here. See above."""

    class IdempotencyLevel(betterproto.Enum):
        """
...
class UninterpretedOption(betterproto.Message):
    ...
    name: List["UninterpretedOption.NamePart"] = betterproto.message_field(2)
    ...
    @dataclass(eq=False, repr=False)
    class NamePart(betterproto.Message):
        """
...
class SourceCodeInfo(betterproto.Message):
    ...
    location: List["SourceCodeInfo.Location"] = betterproto.message_field(1)
    """
...
class GeneratedCodeInfo(betterproto.Message):
    ...
    annotation: List["GeneratedCodeInfo.Annotation"] = betterproto.message_field(1)
    """
