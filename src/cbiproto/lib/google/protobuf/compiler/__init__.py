...
import cbiproto
import cbiproto.lib.google.protobuf as cbiproto_lib_google_protobuf
from cbiproto.runtime.server import ServiceBase


class CodeGeneratorResponseFeature(cbiproto.Enum):
...
class Version(cbiproto.Message):
    """The version number of protocol compiler."""

    major: int = cbiproto.int32_field(1)
    minor: int = cbiproto.int32_field(2)
    patch: int = cbiproto.int32_field(3)
    suffix: str = cbiproto.string_field(4)
    """
...
@dataclass(eq=False, repr=False)
class CodeGeneratorRequest(cbiproto.Message):
    """An encoded CodeGeneratorRequest is written to the plugin's stdin."""

    file_to_generate: List[str] = cbiproto.string_field(1)
    """
    ...
    parameter: str = cbiproto.string_field(2)
    """The generator parameter passed on the command-line."""

    proto_file: List["cbiproto_lib_google_protobuf.FileDescriptorProto"] = cbiproto.message_field(15)
    """
    ...
    compiler_version: "Version" = cbiproto.message_field(3)
    """The version number of protocol compiler."""


@dataclass(eq=False, repr=False)
class CodeGeneratorResponse(cbiproto.Message):
    """The plugin writes an encoded CodeGeneratorResponse to stdout."""

    error: str = cbiproto.string_field(1)
    """
    ...
    supported_features: int = cbiproto.uint64_field(2)
    """
    A bitmask of supported features that the code generator supports. This is a
    bitwise "or" of values from the Feature enum.
    """

    file: List["CodeGeneratorResponseFile"] = cbiproto.message_field(15)


@dataclass(eq=False, repr=False)
class CodeGeneratorResponseFile(cbiproto.Message):
    ...
    insertion_point: str = cbiproto.string_field(2)
    """
    ...
    content: str = cbiproto.string_field(15)
    """The file contents."""

    generated_code_info: "cbiproto_lib_google_protobuf.GeneratedCodeInfo" = cbiproto.message_field(16)
    """
