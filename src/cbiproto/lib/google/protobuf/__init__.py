...
import cbiproto
from cbiproto.runtime.server import ServiceBase
...
class FieldCardinality(cbiproto.Enum):
...
class FieldDescriptorProtoType(cbiproto.Enum):
    TYPE_DOUBLE = 1
...
class FieldDescriptorProtoLabel(cbiproto.Enum):
    LABEL_OPTIONAL = 1
...
class FileOptionsOptimizeMode(cbiproto.Enum):
...
class FieldOptionsCType(cbiproto.Enum):
    STRING = 0
    """Default mode."""
...
class FieldOptionsJsType(cbiproto.Enum):
    JS_NORMAL = 0
...
class MethodOptionsIdempotencyLevel(cbiproto.Enum):
    """
...
class Field(cbiproto.Message):
    ...
    kind: "FieldKind" = cbiproto.enum_field(1)
    """The field type."""

    cardinality: "FieldCardinality" = cbiproto.enum_field(2)
...
class DescriptorProto(cbiproto.Message):
    ...
    extension_range: List["DescriptorProtoExtensionRange"] = cbiproto.message_field(5)
    oneof_decl: List["OneofDescriptorProto"] = cbiproto.message_field(8)
    options: "MessageOptions" = cbiproto.message_field(7)
    reserved_range: List["DescriptorProtoReservedRange"] = cbiproto.message_field(9)
...
@dataclass(eq=False, repr=False)
class DescriptorProtoExtensionRange(cbiproto.Message):
...
@dataclass(eq=False, repr=False)
class DescriptorProtoReservedRange(cbiproto.Message):
    """
...
class FieldDescriptorProto(cbiproto.Message):
    ...
    name: str = cbiproto.string_field(1)
    number: int = cbiproto.int32_field(3)
    label: "FieldDescriptorProtoLabel" = cbiproto.enum_field(4)
    type: "FieldDescriptorProtoType" = cbiproto.enum_field(5)
    """
...
class EnumDescriptorProto(cbiproto.Message):
    ...
    reserved_range: List["EnumDescriptorProtoEnumReservedRange"] = cbiproto.message_field(4)
    """
...
@dataclass(eq=False, repr=False)
class EnumDescriptorProtoEnumReservedRange(cbiproto.Message):
    """
...
class FileOptions(cbiproto.Message):
    ...
    optimize_for: "FileOptionsOptimizeMode" = cbiproto.enum_field(9)
...
class FieldOptions(cbiproto.Message):
    ctype: "FieldOptionsCType" = cbiproto.enum_field(1)
    """
    ...
    jstype: "FieldOptionsJsType" = cbiproto.enum_field(6)
    """
...
class MethodOptions(cbiproto.Message):
    ...
    idempotency_level: "MethodOptionsIdempotencyLevel" = cbiproto.enum_field(34)
    uninterpreted_option: List["UninterpretedOption"] = cbiproto.message_field(999)
    """The parser stores options it doesn't recognize here. See above."""
...
class UninterpretedOption(cbiproto.Message):
    ...
    name: List["UninterpretedOptionNamePart"] = cbiproto.message_field(2)
...
@dataclass(eq=False, repr=False)
class UninterpretedOptionNamePart(cbiproto.Message):
    """
...
class SourceCodeInfo(cbiproto.Message):
    ...
    location: List["SourceCodeInfoLocation"] = cbiproto.message_field(1)
    """
...
@dataclass(eq=False, repr=False)
class SourceCodeInfoLocation(cbiproto.Message):
...
class GeneratedCodeInfo(cbiproto.Message):
    ...
    annotation: List["GeneratedCodeInfoAnnotation"] = cbiproto.message_field(1)
    """
...
@dataclass(eq=False, repr=False)
class GeneratedCodeInfoAnnotation(cbiproto.Message):
    path: List[int] = cbiproto.int32_field(1)
    """
