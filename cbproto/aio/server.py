...
from typing import Any, Collection, Coroutine, Dict, Optional
...
class Server:
    _server: Optional[grpc.aio.Server]
    ...
    def start(self, *, host: Optional[str] = None, port: Optional[int] = None) -> Coroutine[Any, Any, None]:
        if self._server is not None:
            raise RuntimeError("Server is already started")

        self._server = grpc.aio.server(futures.ThreadPoolExecutor(max_workers=self._max_workers))
